...
def test_latency(text_type='short', samples=20):
    """测试响应时间"""
...
def main():
    ...
    all_results['latency_short'] = test_latency('short', samples=15)
    all_results['latency_medium'] = test_latency('medium', samples=10)
    all_results['latency_long'] = test_latency('long', samples=5)
